...
public interface CheckTextsService {

    /**
     * Documentation for the method is taken from the official website and translated into English,
     * see https://yandex.ru/dev/speller/doc/dg/reference/checkTexts.html/ for more info about this method.
     *
     ...
     *
     * @param text Array of texts to check.
     * Limitations:
     ...
     * which may contain other parameters in addition to the text.
     * The maximum size of a query string is 10Kb (2KB in Internet Explorer 6 and 7).
     *
     * @return list of lists of CheckTextResult objects
     */
    @GET("checkTexts")
    Call<List<List<CheckTextResult>>> checkTexts(@Query("lang") String lang, @Query("options") int options, @Query("format") String format, @Query("callback") String callback, @Query("text") String... text);
}
